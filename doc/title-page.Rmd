...
Original datasets, R code for analysis and Rmarkdown code for creation of the manuscript can be accessed at the GitHub repository <https://github.com/efernandezpascual/anthropogenic>. Upon publication, a version of record of the repository will be deposited in Zenodo.